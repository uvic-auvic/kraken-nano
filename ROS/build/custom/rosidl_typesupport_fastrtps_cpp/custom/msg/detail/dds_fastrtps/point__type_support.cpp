...
#include "custom/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom::msg::Point;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const custom::msg::Point *>(
    untyped_ros_message);
...
{
  return &custom::msg::typesupport_fastrtps_cpp::_Point__handle;
}
