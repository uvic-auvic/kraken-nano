...
{
  new (message_memory) custom::msg::Task(_init);
}

void Task_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom::msg::Task *>(message_memory);
  typed_message->~Task();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Task_message_member_array[3] = {
  {
    ...
    offsetof(custom::msg::Task, type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom::msg::Task, direction),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom::msg::Task, magnitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<custom::msg::Task>()
{
  return &::custom::msg::rosidl_typesupport_introspection_cpp::Task_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom, msg, Task)() {
  return &::custom::msg::rosidl_typesupport_introspection_cpp::Task_message_type_support_handle;
}
