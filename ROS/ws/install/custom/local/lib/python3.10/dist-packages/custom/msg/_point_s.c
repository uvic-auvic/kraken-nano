...
bool custom__msg__point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom.msg._point.Point", full_classname_dest, 23) == 0);
  }
  custom__msg__Point * ros_message = _ros_message;
  {  // x
...
PyObject * custom__msg__point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom.msg._point");
