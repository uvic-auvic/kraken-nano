...
class Task(metaclass=Metaclass_Task):
    ...
    def __init__(self, **kwargs):
        ...
        self.magnitude = kwargs.get('magnitude', int())
    ...
    def magnitude(self, value):
        if __debug__:
            assert \
                ...
                "The 'magnitude' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'magnitude' field must be an integer in [-9223372036854775808, 9223372036854775807]"
