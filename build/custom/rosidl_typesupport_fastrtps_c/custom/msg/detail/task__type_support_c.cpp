...
#include "custom/msg/detail/task__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // direction, type
#include "rosidl_runtime_c/string_functions.h"  // direction, type

// forward declare type support functions


using _Task__ros_msg_type = custom__msg__Task;
...
size_t get_serialized_size_custom__msg__Task(
  const void * untyped_ros_message,
...
static uint32_t _Task__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom__msg__Task(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom
size_t max_serialized_size_custom__msg__Task(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom__msg__Task;
    is_plain =
      (
...
static size_t _Task__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom__msg__Task(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom, msg, Task)() {
