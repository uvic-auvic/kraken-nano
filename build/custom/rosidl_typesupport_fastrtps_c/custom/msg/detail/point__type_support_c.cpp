...
#include "custom/msg/detail/point__rosidl_typesupport_fastrtps_c.h"
...
using _Point__ros_msg_type = custom__msg__Point;
...
static uint32_t _Point__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom__msg__Point(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom__msg__Point;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Point__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom__msg__Point(
