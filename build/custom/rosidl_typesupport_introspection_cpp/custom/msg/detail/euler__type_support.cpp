...
{
  new (message_memory) custom::msg::Euler(_init);
}

void Euler_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom::msg::Euler *>(message_memory);
  typed_message->~Euler();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Euler_message_member_array[3] = {
  {
    ...
    offsetof(custom::msg::Euler, yaw),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom::msg::Euler, roll),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom::msg::Euler, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::custom::msg::rosidl_typesupport_introspection_cpp::Euler_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom, msg, Euler)() {
  return &::custom::msg::rosidl_typesupport_introspection_cpp::Euler_message_type_support_handle;
}
