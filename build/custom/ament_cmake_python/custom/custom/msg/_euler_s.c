...
bool custom__msg__euler__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom.msg._euler.Euler", full_classname_dest, 23) == 0);
  }
  custom__msg__Euler * ros_message = _ros_message;
  {  // yaw
...
PyObject * custom__msg__euler__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom.msg._euler");
